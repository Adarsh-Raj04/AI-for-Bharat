...
class IntentRouter:
    ...
    def _initialize_prompts(self):
        ...
        base_system = (
            ...
            "If the context does not contain enough information to answer the question, acknowledge this limitation.\n\n"
            "INSTRUCTIONS:\n"
            "1. Use clear, professional medical language\n"
            "2. Format your response with markdown for readability\n"
            "3. Cite sources using [number] notation corresponding to the context documents\n"
            "4. If the document is not relevant to medical research, state 'This document is not relevant to medical research.'\n"
            "5. For comparison queries, use tables to clearly show differences and similarities:\n"
        )
        ...
        self.clinical_trial_prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    base_system + "TASK: Provide clinical trial information.\n\n"
                    "FORMAT YOUR RESPONSE AS:\n"
                    "## Trial Design\n"
