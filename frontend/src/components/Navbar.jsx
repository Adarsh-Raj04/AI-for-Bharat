      ...
      <nav className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-3 sm:px-4 py-3 flex items-center justify-between relative z-50 transition-colors">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-base sm:text-xl font-bold text-gray-900 dark:text-gray-100 hidden xs:block">MedResearch AI</h1>
            <h1 className="text-base font-bold text-gray-900 dark:text-gray-100 xs:hidden">MedAI</h1>
          </div>
        </div>
